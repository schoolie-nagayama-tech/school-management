...
#### 3-4-1. 実装済み: `src/components/koushu-plan/unitDraftLogic.ts`（2026-09-04・未コミット）
...
#### 3-5-1. 実装済み: `courseSettingAdapter.ts` と、見つかったコマ数の膨らみ（2026-09-04・未コミット）
