      ...
      <div className="flex items-center gap-1 px-3 py-2 border-b bg-gray-50">
        {([
          ...
          <button
            ...
            className={`px-2.5 py-1 text-xs rounded-md transition-[background-color,color] duration-150 ease-out ${
              filter === f.key
        ...
        {canEdit && (
          <button
            className="flex items-center gap-1 px-2 py-1 text-xs text-blue-600 hover:bg-blue-50 rounded transition-[background-color,color] duration-150 ease-out ml-auto"
