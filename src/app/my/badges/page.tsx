                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {recentEarned.map((a, idx) => {
                    ...
                    return (
                      <div
                        key={a.id}
                        className={`stagger-item relative flex items-center gap-3 p-3 bg-white rounded-xl border shadow-sm transition-[box-shadow,transform] duration-150 ease-out [@media(hover:hover)]:hover:shadow-md [@media(hover:hover)]:hover:-translate-y-[1px] ${
