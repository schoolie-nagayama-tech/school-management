...
import { resetDeviceTrustCache, useDeviceTrust } from '@/contexts/DeviceTrustContext';
...
export default function TrustedDevicesPage() {
  ...
  const { refresh: refreshDeviceTrust } = useDeviceTrust();
        ...
        <div className="bg-surface-raised border border-border rounded-xl p-5">
          ...
          {trusted === null ? (
            ...
            <p className="flex items-center gap-2 text-sm font-medium text-text-muted">
              ...
              この端末は未登録です（講師がここからログインすると家モードになります）
            </p>
          )}
        </div>
