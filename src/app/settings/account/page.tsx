        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {/* メール/パスワード */}
              <div className="flex items-center justify-between p-4 bg-[#eff0f3] rounded-lg">
                <div className="flex items-center gap-3">
                  <span className="text-2xl">📧</span>
                  <div>
                    <p className="font-medium text-[#0d0d0d]">メール/パスワード</p>
                    <p className="text-sm text-[#2a2a2a]">{user?.email || '未設定'}</p>
                  </div>
                </div>
              ...
              {canUseGoogleAuth && (
                <div className="flex items-center justify-between p-4 bg-[#eff0f3] rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-[#0d0d0d]">Googleアカウント</p>
              ...
              {!canUseGoogleAuth && (
                <div className="p-4 bg-[#eff0f3] rounded-lg">
                  <p className="text-sm text-[#2a2a2a]">
