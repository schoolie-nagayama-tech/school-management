  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          '講習管理 > 準備スケジュールで、講習開始前の準備タスクを管理できます。教材準備・時間割作成・保護者連絡などのタスクを期日付きで管理します。進捗管理の項目と連動しており、期日を変更すると双方向で同期されます。',
      ...
      },
      {
        ...
        answer:
          '準備スケジュールのタスク期日と進捗管理の項目期日は双方向で同期されます。片方を変更するともう片方に自動反映されます。また、進捗管理で期日が近い・超過している未完了項目は、対象の生徒ごとにアラートとして表示されます（アラート設定で「講習準備」をカスタマイズ可能）。',
