...
values
  ...
  --   ★ -4ヶ月にする理由: d5(-2ヶ月)/d6(今月) と間隔を空け、推移グラフが3点等間隔に近い
  --     見え方になるようにする（保護者ポータルv2 成績案B・2026-07-21）。
  ('d0000000-0000-4000-8000-0000000000d1', 'd0000000-0000-4000-8000-000000000001',
   ...
   date_trunc('month', current_date - interval '4 months')::date, 8,
   date_trunc('month', current_date - interval '4 months')::date, 'term1_mid'),
  ...
  -- d5: 太郎・定期テスト（2学期中間）。d1/d6 と合わせて3件にし、推移グラフに3点並ばせる
  --   （保護者ポータルv2 成績案B・2026-07-21。スタッフが直接入れた行）。
  ('d0000000-0000-4000-8000-0000000000d5', 'd0000000-0000-4000-8000-000000000001',
   'd0000000-0000-4000-8000-000000000021', 'regular_test', '2学期中間',
   date_trunc('month', current_date - interval '2 months')::date, 8,
   date_trunc('month', current_date - interval '2 months')::date, 'term2_mid'),
  -- d6: 太郎・定期テスト（2学期期末）。同上。
  ('d0000000-0000-4000-8000-0000000000d6', 'd0000000-0000-4000-8000-000000000001',
   'd0000000-0000-4000-8000-000000000021', 'regular_test', '2学期期末',
   date_trunc('month', current_date)::date, 8,
   date_trunc('month', current_date)::date, 'term2_final'),
  -- d7: 太郎・内申（2学期）。d3 と合わせて内申を2件にし、推移グラフに2点並ばせる。
  ('d0000000-0000-4000-8000-0000000000d7', 'd0000000-0000-4000-8000-000000000001',
   'd0000000-0000-4000-8000-000000000021', 'report_card', '2学期', null, 8, null, 'term2');
...
values
  ...
  -- d5: 定期テスト（2学期中間・0〜100点）。
  ('d0000000-0000-4000-8000-0000000000d5', 'english', 78),
  ('d0000000-0000-4000-8000-0000000000d5', 'math', 84),
  ('d0000000-0000-4000-8000-0000000000d5', 'japanese', 70),
  ('d0000000-0000-4000-8000-0000000000d5', 'social', 73),
  ('d0000000-0000-4000-8000-0000000000d5', 'science', 79),
  -- d6: 定期テスト（2学期期末・0〜100点）。
  ('d0000000-0000-4000-8000-0000000000d6', 'english', 82),
  ('d0000000-0000-4000-8000-0000000000d6', 'math', 88),
  ('d0000000-0000-4000-8000-0000000000d6', 'japanese', 74),
  ('d0000000-0000-4000-8000-0000000000d6', 'social', 77),
  ('d0000000-0000-4000-8000-0000000000d6', 'science', 83),
  -- d7: 内申（2学期・1〜5の5段階、中学は9科）。
  ('d0000000-0000-4000-8000-0000000000d7', 'english', 4),
  ('d0000000-0000-4000-8000-0000000000d7', 'math', 5),
  ('d0000000-0000-4000-8000-0000000000d7', 'japanese', 4),
  ('d0000000-0000-4000-8000-0000000000d7', 'social', 3),
  ('d0000000-0000-4000-8000-0000000000d7', 'science', 4),
  ('d0000000-0000-4000-8000-0000000000d7', 'music', 3),
  ('d0000000-0000-4000-8000-0000000000d7', 'art', 4),
  ('d0000000-0000-4000-8000-0000000000d7', 'tech_home', 4),
  ('d0000000-0000-4000-8000-0000000000d7', 'pe', 4);
...
values
  ...
  --   ★ exam_month は d1 の変更（-2ヶ月→-4ヶ月）に合わせる（承認済み申請と転記先は
  --     同じ枠でなければならないため。§7-5 の同一枠判定）。
  ('d0000000-0000-4000-8000-0000000000e1', 'd0000000-0000-4000-8000-000000000001',
   ...
   'regular_test', 8, 'term1_mid', date_trunc('month', current_date - interval '4 months')::date,
  ...
  --   ★ exam_month を -3ヶ月にする理由: d1(-4ヶ月)/d5(-2ヶ月)/d6(今月) の間に挟まないと
  --     いけない訳ではないが、既存の「今月」のままだと d6(term2_final, 今月) と
  --     枠（category/grade/name_code/exam_month）は違う（name_code が異なる）ため衝突はしない。
  --     とはいえ term1_final を今月に置くと季節感が不自然なので、term1系の並びに合わせて
  --     -3ヶ月に寄せる（保護者ポータルv2 成績案B・2026-07-21）。
  ('d0000000-0000-4000-8000-0000000000e2', 'd0000000-0000-4000-8000-000000000001',
   'd0000000-0000-4000-8000-000000000021', 'd0000000-0000-4000-8000-000000000031',
   'regular_test', 8, 'term1_final', date_trunc('month', current_date - interval '3 months')::date,
